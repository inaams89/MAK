          ...
          {services.length > 0 ? (
            services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-red-600 to-red-800 bg-opacity-90 p-4 sm:p-6 mx-4 sm:mx-8 mb-4 sm:mb-6 rounded-2xl text-center transform transition-all duration-500 ease-in-out group-hover:scale-105">
